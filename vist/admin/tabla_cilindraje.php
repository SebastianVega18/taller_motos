<?php 
    ...
    $consul=$conectar->prepare("SELECT * From cilindraje");
    $consul->execute();
?>
<script type="text/javascript">
	...
	<caption><label>Cilindraje</label></caption>
	<tr>
        <td>Referencia</td>
		<td>Nombre</td>
	...
	<tr>
        ...
        <form method="get" action="actucilin.php"> 
            ...
            <input type="hidden" name="actu" value="<?php echo $produ['id_cilindraje']?>">
		...
		<td>
        <form method="post" action="eliminarcilin.php" > 
			<button type="submit" class="btn btn-danger btn-s" onclick="return ConfirmDelete()" >
              <input type="hidden" name="elimi" value="<?=$produ["id_cilindraje"]?>">
