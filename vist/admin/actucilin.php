...
<?php
        ...
        if ((isset($_POST["actualizar"]))&&($_POST["actualizar"]=="form"))
        {
            ...
            {
                $actusql=$conectar->prepare("UPDATE cilindraje SET cilindraje ='$nombre', precio = '$precio' WHERE id_cilindraje='".$_GET['actu']."'");
                $actusql->execute();
			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmArticulos"  name="formu" method="post" >
                        ...
                        <label>Precio</label>
                        <input type="number" oninput="maxlengthNumber(this)" maxlength="10" class="form-control input-sm" id="marca" name="precio" value="<?php echo $query['precio'] ?>">
						<br>
