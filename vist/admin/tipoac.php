			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmArticulos"  name="formu" method="post" >
						...
						<input type="text" oninput="multipletext(this)" maxlength="12" class="form-control input-sm" id="nombre" name="nombreu"  value="<?php echo $query['tip_usu'] ?>">
                        ...
                        <button type="submit" class="btn btn-warning"><a href="tip_usu.php" style="color:#fff">Regresar</a></button>
					</form>
				</div>
