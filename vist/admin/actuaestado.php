			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmArticulos"  name="formu" method="post" >
						...
						<label>Estado</label>
						<input type="text" oninput="multipletext(this)" maxlength="15" class="form-control input-sm" id="nombre" name="nombreu"  value="<?php echo $query['estados'] ?>">
                        ...
                        <button type="submit" class="btn btn-warning"><a href="estado.php" style="color:#fff">Regresar</a></button>
					</form>
				</div>
